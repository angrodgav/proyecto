...
public class WeatherForecastTest {
	...
	@Test
	public void Give_CorrectParameters_WhenGetCityWeather_Then_GetCorrectWeatherStates() throws IOException {
		String forecast = weatherForecast.getCityWeather("Madrid", new Date());
		assertNotNull(forecast);
	}
	
	@Test(expected = JSONException.class)
	public void Give_NullCity_WhenGetCityWeather_Then_ThrowJSONException() throws IOException {
		weatherForecast.getCityWeather(null, new Date());
	}
	
	@Test
	public void Give_NullDate_WhenGetCityWeather_Then_GetCorrectWeatherStates() throws IOException {
		String forecast = weatherForecast.getCityWeather("Madrid", null);
		assertNotNull(forecast);
	}
	
	@Test(expected = JSONException.class)
	public void Give_WrongCity_WhenGetCityWeather_Then_ThrowJSONException() throws IOException {
		weatherForecast.getCityWeather("Madrida", new Date());
	}
	
	@Test
	public void Give_PartOfCorrectCityName_WhenGetCityWeather_Then_GetCorrectWeatherStatesOfARamdomCityOfQuery() throws IOException {
	...
	@Test
	public void Give_Plus6DaysLater_WhenGetCityWeather_Then_GetEmptyResponse() throws IOException {
	...
	/**TODO 144 hours does not necessarily mean 6 days due to the time change, we must refine more  **/
	@Test
	public void Give_Is6DaysLater_WhenGetCityWeather_Then_GetEmptyResponse() throws IOException {
	...
	/**TODO 144 hours does not necessarily mean 6 days due to the time change, we must refine more  **/
	@Test
	public void Give_Is5DaysLater_WhenGetCityWeather_Then_GetCorrectWeatherStates() throws IOException {
	...
	@Test
	public void Give_PastDate_WhenGetCityWeather_Then_GetEmptyResponse() throws IOException {
